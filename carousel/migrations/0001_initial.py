...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'cmsplugin_galleryplugin', (
            ...
            ('template', self.gf('django.db.models.fields.CharField')(default='carousel/gallery.html', max_length=255)),
        ))
        db.send_create_signal(u'carousel', ['GalleryPlugin'])

        # Adding model 'Image'
        db.create_table(u'carousel_image', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('inline_ordering_position', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('gallery', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['carousel.GalleryPlugin'])),
            ('src', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='gallery_image', null=True, to=orm['filer.Image'])),
        ...
        db.send_create_signal(u'carousel', ['Image'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'carousel_image')
    ...
    models = {
        ...
        u'carousel.galleryplugin': {
            'Meta': {'object_name': 'GalleryPlugin', 'db_table': "u'cmsplugin_galleryplugin'", '_ormbases': ['cms.CMSPlugin']},
            u'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
            'template': ('django.db.models.fields.CharField', [], {'default': "'carousel/gallery.html'", 'max_length': '255'})
        },
        u'carousel.image': {
            'Meta': {'ordering': "('inline_ordering_position',)", 'object_name': 'Image'},
            'alt': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'gallery': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['carousel.GalleryPlugin']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inline_ordering_position': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'src': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'gallery_image'", 'null': 'True', 'to': "orm['filer.Image']"}),
