...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Event.image_height'
        db.delete_column(u'events_event', 'image_height')

        # Deleting field 'Event.image_width'
        db.delete_column(u'events_event', 'image_width')


    def backwards(self, orm):
        # Adding field 'Event.image_height'
        db.add_column(u'events_event', 'image_height',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Event.image_width'
        db.add_column(u'events_event', 'image_width',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)
