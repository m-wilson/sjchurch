...
#         return ('events:category-event-list', (), {
#             'slug': self.slug,
#         })
...
class Event(models.Model):
    ...
    organiser= models.ManyToManyField(Individual, through= 'EventOrganiser')
    category = models.ManyToManyField(Category, through= 'EventCategory')
...
class UpcomingEvents(CMSPlugin):
    number_of_events= models.PositiveIntegerField(default= 5)
